...
Revision ID: 5fcdc9f22b13
Revises: 
Create Date: 2020-08-16 22:04:35.542122
...
def upgrade():
    ...
    sa.Column('trackItem', sa.String(length=1000), nullable=True),
    sa.Column('trackItemError', sa.Boolean(), nullable=True),
    sa.Column('retailer', sa.String(length=500), nullable=True),
    ...
    sa.Column('tld', sa.String(length=500), nullable=True),
    sa.Column('tldError', sa.Boolean(), nullable=True),
    sa.Column('upc', sa.String(length=1000), nullable=True),
    ...
    op.create_table('data_about_catalog',
    sa.Column('thisTLD', sa.String(length=5), nullable=True),
    sa.Column('thisFileName', sa.String(length=1000), nullable=False),
    sa.PrimaryKeyConstraint('thisFileName'),
    sa.UniqueConstraint('thisTLD')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('data_about_catalog')
